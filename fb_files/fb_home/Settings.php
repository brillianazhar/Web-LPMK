...
<?php
	if(isset($_POST['change_name']))
	{
		...
		mysqli_query($konek,"update users set Name='$Name' where user_id=$userid;");
	...
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($konek,"update users set Password='$new_password' where user_id=$userid;");
		}
		else
		{
	...
	{
		$uid=$_POST['uid'];
		mysqli_query($konek,"delete from users where user_id=$uid;");
...
<div style="position:fixed;  left:41%; top:19%; z-index:3"><h1 style="color:#FFFFFF;"> Change Name </h1> </div>
