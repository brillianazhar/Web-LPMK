...
error_reporting(1);
	...
	$que1=mysqli_query($konek,"select * from users where Email='$Email'");
	...
	else
	{
		...
		{
			$que2=mysqli_query($konek,"insert into users(Name,Email,Password,Gender,Birthday_Date,FB_Join_Date) values('$Name','$Email','$Password','$Gender','$Birthday_Date','$FB_Join_Date')");
