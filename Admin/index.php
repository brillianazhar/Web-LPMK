    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(judul like '%" . $array_katakunci[$x] . "%' or kelurahan like '%" . $array_katakunci[$x] . "%' or isi like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        <tr>
            ...
            <td><?php echo $r1['kelurahan'] ?></td>
            <td>
                <a href="halaman_input.php?id=<?php echo $r1['id']?>">
                    <span class="badge bg-warning text-dark">Edit</span>
                </a>

                <a href="index.php?op=delete&id=<?php echo $r1['id'] ?>"
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        <li class="page-item">
            <a class="page-link"
                href="index.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
        </li>
        <?php
        }
        ?>
