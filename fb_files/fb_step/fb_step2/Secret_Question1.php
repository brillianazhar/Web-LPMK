<?php
	...
	if(isset($_SESSION['tempfbuser']))
	{
		...
		if($count1==0)
		{
			...
			$que3=mysqli_query($konek,"select * from user_profile_pic where user_id=$userid");
...
<?php
	if(isset($_POST['Next']))
	{
		...
		mysqli_query($konek,"insert into user_secret_quotes(user_id,Question1,Answer1) values('$userid','$que1','$ans1')");
