...
<?php
	...
	$que1=mysqli_query($konek,"select * from user_secret_quotes where user_id=$userid and Answer2='$ans2'");
	$count1=mysqli_num_rows($que1);
	
	if($count1>0)
	{
		$que2=mysqli_query($konek,"select * from users where user_id=$userid");
